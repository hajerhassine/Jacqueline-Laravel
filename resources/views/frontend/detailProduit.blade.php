...
<body class="single single-product woocommerce woocommerce-page body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide preloader wpb-js-composer sc_responsive">
                ...
                <div class="content_wrap">
                    <div class="post_navi">
                        <span class="post_navi_item post_navi_prev">
                            <a href="single-product.html" rel="prev">{{ $produits->produit_name }}</a>
                        </span>
                    ...
                    <div class="breadcrumbs">
                        ...
                        <span class="breadcrumbs_delimiter"></span>
                        <a class="breadcrumbs_item cat_post" href="#">{{ $produits->produit_name }}</a>
                ...
                <div class="content">
                    <article class="post_item post_item_single post_item_product">
                        <nav class="woocommerce-breadcrumb">
                            ...
                            <a href="#">Contouring Make Up</a>&nbsp;&#47;&nbsp;{{ $produits->produit_name }}
                        </nav>
                        <div class="product">
                            <div class="images">
                                <a href="images/370x370.jpg" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto">
                                    <img width="600" height="765" src="{{ asset($produits->produit_image) }}" class="attachment-shop_single size-shop_single " alt="" title="3473311970015_94"/></a>
                            </div>
                            <div class="summary entry-summary">
                                <h1 class="product_title entry-title">{{ $produits->produit_name }}</h1>
                                <div>
                                    <p class="price">
                                        <span class="woocommerce-Price-amount amount">
                                            <span class="woocommerce-Price-currencySymbol">&pound;</span>25.41
                                        </span>
                                    </p>
                                </div>
                                <div>
                                    <p>
                                    {{ $produits->produits->ShortDescription }}
                                    </p>
                                    <p>
                                    {{ $produits->produits->LongDescription }}
                                    </p>
                                ...
                                <div class="product_meta">
                                    <span class="posted_in">Category:
                                        <a href="#" rel="tag">Contouring Make Up</a>
                                    </span>
                                        ...
                                        <div id="review_form_wrapper">
                                            <div id="review_form">
                                                <div id="respond" class="comment-respond">
                                                    <h3 id="reply-title" class="comment-reply-title">Be the first to review &ldquo;CONCEALER STICK&rdquo;</h3>
