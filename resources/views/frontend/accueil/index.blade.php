                                                            ...
                                                            <div class="post_featured">
                                                                <div class="post_thumb" data-image="images/1170x700.jpg" data-title="How massage loses its value">
                                                                    <a class="hover_icon hover_icon_link" href="single-post.html">
                                                                        ...
                                                                        <img src="{{ $offre->offre_image}}">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="post_content isotope_item_content">
                                                                <div class="post_category">
                                                                    <a href="#" rel="tag">{{ $offre->offre_name }}</a>
                                                                </div>
                                                                <h4 class="post_title">
                                                                    <a href="single-post.html">{{ $offre->offre_description}}</a>
                                                                </h4>
                                                                <div class="post_info">

                                                                    <span class="post_info_item "> Prix
                                                                        <a href="single-post.html" class="post_info_author">{{ $offre->offre_price }}</a>
                                                                    </span>
                                                                </div>
