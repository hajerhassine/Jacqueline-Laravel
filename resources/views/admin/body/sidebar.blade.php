<aside class="left-sidebar bg-sidebar">
  ...
  <li  class="active" >
    <a class="sidenav-item-link" href="{{ route('all.offre') }}">
      <span class="nav-text">Offre</span>
      
    </a>
  </li> 
  <li  class="active" >
    <a class="sidenav-item-link" href="{{ route('all.categ') }}">
  ...
  <li  class="active" >
    <a class="sidenav-item-link" href="{{ route('all.seance') }}">
      <span class="nav-text">Seance</span>
      
    </a>
  </li>
 
  <li  class="active" >
    <a class="sidenav-item-link" href="{{ route('all.rendezvousBack') }}">
...
<a class="sidenav-item-link" href="{{ route('all.categorie') }}">
    <span class="nav-text">Catégorie Centre</span>
...
<a class="sidenav-item-link" href="{{ route('all.centre') }}">
    <span class="nav-text">Centre</span>
