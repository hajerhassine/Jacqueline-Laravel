...
Route::get('/produits', [ProduitController::class, 'produits'])->name('all.produits');
Route::post('/produit/add', [ProduitController::class, 'Storeproduit'])->name('store.produit');
Route::get('/produit/detail/{id}', [ProduitController::class, 'detail']);
...
Route::get('/produit/pdf',[CategorieproduitController::class, 'createPDF']);
